<?php
	...
	class companyController extends mainModel{
		...
		/*----------  Controlador obtener empresa  ----------*/
		public function obtenerEmpresaControlador(){
			// Realizar consulta a la base de datos para obtener los datos de la empresa
			$datos = $this->ejecutarConsulta("SELECT * FROM empresa WHERE empresa_id='1'"); // Ajusta según el ID de tu empresa
